# Shared Nix Home Manager Modules
...
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/robinwalterfit/nix-home-modules)

Reusable Nix Home Manager Modules.

## What This Is

This project provides reusable modules for [Home Manager](https://github.com/nix-community/home-manager). It does not define new features or functionality that is not already available in Home Manager, but instead provides pre-configured `programs` and `services`, which can be used as a configuration base to not start from scratch.
...
- `nix/modules/`: Holds the `homeModules` this project provides.
- `nix/lib.nix`: Holds general reusable or project specific values
...
- `nix-home-modules` repository: [https://github.com/robinwalterfit/nix-home-modules](https://github.com/robinwalterfit/nix-home-modules)
- Issue tracker: [https://github.com/robinwalterfit/nix-home-modules/issues](https://github.com/robinwalterfit/nix-home-modules/issues)
- More Links:
...
`nix-home-modules` is [MIT licensed](./LICENSE) and moderated under the [Contributor Covenant Code of Conduct](./.github/CODE_OF_CONDUCT.md).
