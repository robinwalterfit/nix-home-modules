...
First off, thank you for considering contributing to `nix-home-modules`! Everybody is invited and welcome to contribute to this project.
...
There are many ways to contribute, from writing tutorials and blog posts, improving the (code) documentation, submitting bug reports and feature requests or writing source code which can be incorporated into `nix-home-modules` itself.
...
1. Create your own [fork of the code](https://github.com/robinwalterfit/nix-home-modules/fork)
